...
def helsinki_municipality():
    ...
    division.set_current_language("fi")
    division.name = "Helsinki"
    division.set_current_language("sv")
    division.name = "Helsingfors"
    division.save()
...
def test_import_divisions(helsinki_municipality, helsinki_importer, subtests, caplog):
    ...
    with subtests.test(msg="major_district"):
        ...
        assert _name(major_1, "fi") == "Eteläinen"
        assert _name(major_1, "sv") == "Södra"
        ...
        assert _name(major_2, "fi") == "Pohjoinen"
        assert _name(major_2, "sv") == "Norra"
    ...
    with subtests.test(msg="district"):
        ...
        assert _name(district_1, "fi") == "Kamppi"
        assert _name(district_1, "sv") == "Kampen"
        ...
        assert _name(district_2, "fi") == "Malmi"
        assert _name(district_2, "sv") == "Malm"
    ...
    with subtests.test(msg="sub_district"):
        ...
        assert _name(sub_1, "fi") == "Kamppi 1"
        assert _name(sub_1, "sv") == "Kampen 1"
        assert sub_1.parent == district_1
        assert sub_1.ocd_id == f"{MUNI_OCD}/osa-alue:kamppi_1"

        sub_2 = _get("sub_district", origin_id="2001")
        assert _name(sub_2, "fi") == "Malmi 1"
        assert _name(sub_2, "sv") == "Malm 1"
    ...
    with subtests.test(msg="small_district"):
        ...
        assert _name(small_1, "fi") is None
        ...
        assert _name(small_2, "fi") is None
    ...
    with subtests.test(msg="voting_district"):
        ...
        assert _name(voting_1, "fi") == "Äänestysalue 1"
        ...
        assert _name(voting_2, "fi") == "Äänestysalue 2"
    ...
    with subtests.test(msg="maternity_clinic_district"):
        ...
        assert _name(maternity, "fi") == "nv01"
    ...
    with subtests.test(msg="emergency_care_district"):
        ...
        assert _name(emergency, "fi") == "paiv01"
    ...
    with subtests.test(msg="rescue_area"):
        ...
        assert _name(rescue_a, "fi") == "Suojelupiiri 1"
        assert _name(rescue_a, "sv") == "Skyddsdistrikt 1"
    ...
    with subtests.test(msg="rescue_district"):
        ...
        assert _name(rescue_d, "fi") == "Suojelulohko 1"
        assert _name(rescue_d, "sv") == "Skyddssektion 1"
    ...
    with subtests.test(msg="rescue_sub_district"):
        ...
        assert _name(rescue_sd, "fi") == "Suojelualalohko 1"
        assert _name(rescue_sd, "sv") == "Skyddsundersektion 1"
    ...
    with subtests.test(msg="statistical_district"):
        ...
        assert _name(stat, "fi") == "Tilastoalue 1"
    ...
    with subtests.test(msg="nature_reserve"):
        ...
        assert _name(nature, "fi") == "Vanhankaupunginlahti"
    ...
    with subtests.test(msg="resident_parking_zone"):
        ...
        assert _name(parking_zone, "fi") == "Kamppi"
    ...
    with subtests.test(msg="parking_area"):
        ...
        assert _name(parking_1, "fi") is None
    ...
    with subtests.test(msg="parking_payzone"):
        ...
        assert _name(payzone, "fi") == "Vyöhyke 1"
