    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "number",
                    models.CharField(
                        blank=True, help_text="Building number", max_length=6
                    ),
                ),
                (
                    "number_end",
                ...
                (
                    ...
                    django.contrib.gis.db.models.fields.PointField(
                        help_text="Coordinates of the address", srid=DEFAULT_SRID
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Human-readable name for the division", max_length=100
                    ),
                ),
            ],
        ),
                ...
                (
                    ...
                    models.DateTimeField(
                        ...
                        default=datetime.datetime(
                            1970, 1, 1, 2, 0, tzinfo=datetime.timezone.utc
                        ),
                        help_text="Time when the information was last changed",
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="munigeo.POICategory"
            ),
        ),
        migrations.AddField(
            model_name="poi",
            name="municipality",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="munigeo.Municipality"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="plan",
