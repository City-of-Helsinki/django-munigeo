    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "number",
                    models.CharField(
                        max_length=6, blank=True, help_text="Building number"
                    ),
                ),
                (
                    "number_end",
                ...
                (
                    ...
                    django.contrib.gis.db.models.fields.PointField(
                        srid=DEFAULT_SRID, help_text="Coordinates of the address"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "service_point_id",
                    models.CharField(
                        null=True, max_length=50, blank=True, db_index=True
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        unique=True,
                        db_index=True,
                        help_text="Type name of the division (e.g. muni, school_district)",
                    ),
                ),
                (
                    "name",
                    models.CharField(
                        max_length=100, help_text="Human-readable name for the division"
                    ),
                ),
            ],
            options={},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "municipality",
                    models.ForeignKey(
                        to="munigeo.Municipality", on_delete=models.CASCADE
                    ),
                ),
            ],
            options={},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "location",
                    django.contrib.gis.db.models.fields.PointField(srid=DEFAULT_SRID),
                ),
                (
                    "street_address",
        ...
        migrations.AddField(
            ...
            name="type",
            field=models.ForeignKey(
                to="munigeo.AdministrativeDivisionType", on_delete=models.CASCADE
            ),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
        ...
        migrations.AddField(
            ...
            name="street",
            field=models.ForeignKey(
                related_name="addresses", to="munigeo.Street", on_delete=models.CASCADE
            ),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
